...
module.exports = {
    ...
    join: function (req, res) { 
      ...
      sails.sockets.join(req, req.param('deviceId'));
      ...
      // io.socket.on('hello', function (broadcastedData){
        ...
        return res.json({
            status: `${req.param("deviceId")} joined successfully`
        });
     },
     publish: function (req, res) { 
       ...
       sails.sockets.broadcast(req.param('deviceId'), req.param('event'), req.body);
       return res.json({
            status: `${req.param("deviceId")} published successfully`
       });
    }
};
